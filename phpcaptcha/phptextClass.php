...
{	
	public function phptext($text,$textColor,$backgroundColor='',$fontSize,$imgWidth,$imgHeight,$dir,$fileName){
		...
		if($backgroundColor==''){/*select random color*/
			$colorCode=array('#ff00ff', '#ffff00', '#00ffff');
	...
	public function phpcaptcha($textColor,$backgroundColor,$imgWidth,$imgHeight,$noiceLines=0,$noiceDots=0,$noiceColor='#cdcdcd'){
		$text=$this->random();
	...
	/*for random string*/
	protected function random($characters=6,$letters = '123456789abcdfghjkmnpqrstvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ'){
		$str='';
